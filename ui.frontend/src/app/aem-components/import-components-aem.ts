 ...
 */
MapTo('siteangular/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('siteangular/components/separator')(SeparatorV1Component);

MapTo('siteangular/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('siteangular/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('siteangular/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('siteangular/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('siteangular/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('siteangular/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('siteangular/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('siteangular/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('siteangular/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('siteangular/components/accordion')(AccordionV1Component);
MapTo('siteangular/components/tabs')(TabsV1Component);
...
LazyMapTo('siteangular/components/teaser')(TeaserV1Component);
...
LazyMapTo('siteangular/components/carousel')(CarouselV1Component);
